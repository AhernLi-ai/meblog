...
export default function WechatQR({ variant = 'article-end' }: WechatQRProps) {
  ...
  if (variant === 'sidebar') {
    return (
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
        <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20">
  ...
  // article-end variant
  return (
    <div className="mt-12 py-8 border-t border-b border-gray-200 dark:border-gray-700 flex flex-col items-center">
      <div className="flex flex-col items-center">
        <img
          src={siteSettings.wechat_qr_url}
          alt="微信公众号二维码"
          className="w-48 h-48 object-contain rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm"
        />
        <p className="mt-4 text-base text-gray-600 dark:text-gray-300 text-center">
          {siteSettings.wechat_guide_text}
        </p>
      </div>
    </div>
