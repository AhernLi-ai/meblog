        ...
        <div className="flex justify-between items-center h-full">
          ...
          {isAuthenticated ? (
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <Link
                to="/register"
                className="px-4 py-2 text-sm font-medium text-white bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] rounded-[8px] transition-colors shadow-[var(--shadow-card)]"
              >
                注册
              </Link>
            </div>
          ...
          <div className="py-2">
            ...
            {!isAuthenticated && (
              <>
                ...
                <Menu.Item>
                  {({ active }) => (
                    <Link to="/login" className={`flex items-center gap-2 px-4 py-3 text-sm ${active ? 'bg-[var(--color-primary)] text-white' : 'text-[var(--color-foreground)]'}`}>
                      登录
                    </Link>
                  )}
                </Menu.Item>
