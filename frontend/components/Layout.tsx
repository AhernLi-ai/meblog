            ...
            <div className="bg-[var(--color-background)] rounded-[12px] shadow-[var(--shadow-card)] border border-[var(--color-border)] overflow-hidden transition-all duration-300 hover:shadow-[var(--shadow-card-hover)]">
              <div className="p-5">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full overflow-hidden border border-[var(--color-border)] bg-[var(--color-background-secondary)] shrink-0">
                  ...
                  <div className="min-w-0">
                    <p className="text-xs text-[var(--color-foreground-secondary)] tracking-wide">作者</p>
                    <p className="text-base font-semibold text-[var(--color-foreground)] truncate">{about?.username || '作者'}</p>
                  </div>
                </div>
