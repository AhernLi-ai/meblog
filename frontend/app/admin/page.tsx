      ...
      <div>
        ...
        <div className="bg-[var(--color-background)] rounded-[12px] shadow-[var(--shadow-card)] p-6 border border-[var(--color-border)]">
          ...
          <div className="flex gap-4">
            <Link href="/admin/posts/new" className="px-4 py-2 bg-[var(--color-primary)] text-white rounded-[8px] hover:bg-[var(--color-primary-hover)] transition-colors">
              写文章
            </Link>
            <Link href="/" className="px-4 py-2 bg-[var(--color-background-secondary)] text-[var(--color-foreground)] rounded-[8px] hover:bg-[var(--color-border)] transition-colors">
              查看博客
            </Link>
          </div>
        </div>
