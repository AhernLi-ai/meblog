      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex justify-between items-center h-full">
          ...
          <div className="hidden md:flex items-center gap-1">
            <NavLink href="/" icon={<HomeIcon className="w-4 h-4" />} label="首页" isActive={pathname === '/'} />
            <NavLink href="/projects" icon={<FolderIcon className="w-4 h-4" />} label="项目" isActive={pathname === '/projects'} />
            <NavLink href="/tags" icon={<TagIcon className="w-4 h-4" />} label="标签" isActive={pathname === '/tags'} />
            <NavLink href="/archive" icon={<ClockIcon className="w-4 h-4" />} label="归档" isActive={pathname === '/archive'} />
            <NavLink href="/about" icon={<UserCircleIcon className="w-4 h-4" />} label="关于" isActive={pathname === '/about'} />
