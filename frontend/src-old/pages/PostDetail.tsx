  ...
  return (
    <div>
      ...
      <article className="max-w-4xl mx-auto">
        ...
        <header className="mb-6 text-center">
          ...
          <div className="inline-block text-left">
            <div className="text-base text-[var(--color-foreground-secondary)] mb-1">
              ...
              <span>:</span>
              <Link to="/about" className="text-[var(--color-primary)] hover:underline ml-1">
            ...
            {post.project && (
              <div className="text-base text-[var(--color-foreground-secondary)] mb-1">
                ...
                <span>:</span>
                <Link to={`/category/${post.project.slug}`} className="text-[var(--color-primary)] hover:underline ml-1">
                  {post.project.name}
                </Link>
              </div>
            )}
        ...
        {/* Comments section */}
        {slug && <Comments postSlug={slug} postId={post.id} />}
